    ...
    if (signatureURL) {
      signature = (
        <div className="signatureImg">
          <img alt="Error: Please clear and sign manually" src={this.state.signatureURL} /> {this.state.userInfo.firstName} {this.state.userInfo.lastName} {moment().format(dateFormat)}
        </div>
      );
    } else {
